...
const PostItem = React.memo(({ index, style, data }) => {
  ...
  const getSeverityColor = (score) => {
    ...
    if (score >= 5) return "border-l-purple-500";
...
const VirtualizedSocialFeed = ({
  ...
  // Debug logging
  console.log('🎯 VirtualizedSocialFeed props:', { posts, postsLength: posts?.length, loading, hasNextPage });
      ...
      <div className="h-full flex flex-col items-center justify-center bg-gray-50">
        <div className="text-center p-8">
          ...
          <p className="text-gray-500 mb-4">
            {loading ? 'Loading posts...' : 'There are no social media posts to display at this time.'}
          </p>
          {!loading && (
            <button
